document.addEventListener("DOMContentLoaded", function () {
    ...
    async function fetchDashboardData(filter = "weekly", startDate = null, endDate = null) {
        ...
        try {
            ...
            const totalIncome = await fetchFinanceData("http://192.168.100.31:8005/total-income/");
            const totalExpenses = await fetchFinanceData("http://192.168.100.31:8005/total-expenses/");
